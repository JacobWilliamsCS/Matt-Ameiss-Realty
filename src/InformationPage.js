...
function InformationPage() {
  ...
  const descriptions = [
    ...
    "Make your real estate endeavors a joy with Matt's expert counsel. His commitment, patience, and passion ensure that you not only achieve a stress-free experience but also gain a profound understanding of buying, selling, or building in the real estate realm.",
    "With Matt as your trusted real estate advisor, navigating important transactions is a breeze. His commitment to excellence, unwavering support, and passion for real estate ensure that you not only enjoy a stress-free experience but also gain clarity on all aspects of buying, selling, or building your property."
  ...
  return (
    ...
    <div className="property-image px-4" style={{ width: '500px' }}>
      ...
      <a href="https://www.facebook.com/matt.ameiss" style={{ display: 'block', marginTop: '10px' }}>
        ...
        <div className="description-card white px-4">
